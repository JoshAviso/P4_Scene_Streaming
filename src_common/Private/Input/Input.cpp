...
{
    switch (Mouse.Mode) {
    case Normal:    glfwSetInputMode(Application::GetWindow()->_window, GLFW_CURSOR, GLFW_CURSOR_NORMAL); break;
    case Locked:    glfwSetInputMode(Application::GetWindow()->_window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); break;
    case Hidden:    glfwSetInputMode(Application::GetWindow()->_window, GLFW_CURSOR, GLFW_CURSOR_HIDDEN); break;
    case Bounded:    glfwSetInputMode(Application::GetWindow()->_window, GLFW_CURSOR, GLFW_CURSOR_CAPTURED); break;
    }
...
void Input::MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    if (button == GLFW_MOUSE_BUTTON_LEFT) {
        ...
        if (!Mouse.RightDown && isPressed) Mouse.RightPressed = true;
        if (Mouse.RightDown && !isPressed) Mouse.RightReleased = true;
...
{
    Input::Mouse.ScrollDelta = (float)yOffset;
}
